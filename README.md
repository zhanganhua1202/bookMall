...
2. 创建JavaEE三层架构对应的包
   ...
   service层：
    	com.xxxx.service（Service接口包）
    	com.xxxx.service.impl（Service接口实现类）
   dao持久层：
       com.xxxx.dao（Dao接口包）
       com.xxxx.dao.impl（Dao接口实现类）
   实体bean对象：
   	com.xxxx.pojo/entity/domain/bean（JavaBean类）
   测试包：
   	com.xxxx.test/junit
   工具类：
   	com.xxxx.utils
...
import com.xxxx.dao.impl.UserDao;
import com.xxxx.pojo.User;
...
import com.xxxx.dao.impl.UserDaoImpl;
import com.xxxx.pojo.User;
...
import com.xxxx.utils.WebUtils;
...
import com.xxxx.dao.BookDao;
import com.xxxx.dao.impl.BookDaoImpl;
import com.xxxx.pojo.Book;
import com.xxxx.pojo.Page;
...
import com.xxxx.pojo.Page;
import com.xxxx.service.BookService;
import com.xxxx.service.impl.BookServiceImpl;
import com.xxxx.utils.WebUtils;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
...
import com.xxxx.dao.OrderDao;
import com.xxxx.dao.impl.BookDaoImpl;
import com.xxxx.dao.impl.OrderDaoImpl;
import com.xxxx.pojo.Book;
import com.xxxx.pojo.Car;
import com.xxxx.pojo.Order;
...
import com.xxxx.pojo.User;
import com.xxxx.service.OrderService;
import com.xxxx.service.impl.OrderServiceImpl;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
